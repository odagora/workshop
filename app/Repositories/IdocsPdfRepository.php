...
trait IdocsPdfRepository {
        ...
        public function printIdocsPdf($id){
                ...
                $pdf = \PDF::loadView('idocs.pdf', compact('idoc', 'make', 'type', 'names', 'items', 'cats', 'elements', 'comments'))->setPaper('Letter')->setOption('margin-top', 4)->setOption('margin-left', 6)->setOption('margin-right', 6)->setOption('footer-spacing', 2)->setOption('footer-left', "[doctitle] | Impreso el: [date]")->setOption('footer-right', "Pagina [page] de [toPage]")->setOption('footer-font-size', 7);
