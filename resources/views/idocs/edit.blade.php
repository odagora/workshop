		...
		<div class="form-group">
			<div class="row">
				<div class="col-md-3">
					...
					{{ Form::date('created_at',  $idoc->created_at->format('Y-m-d'), array('class' =>'form-control'))}}
				</div>
			</div>
		</div>
    	<div class="form-group">
...
<div class="row ">
	<div class="col-xs-6 col-sm-6 col-md-4 col-md-offset-2 edit-buttons">
		<div class="col-xs-6 col-sm-6 col-md-6">
			{!! Html::linkRoute('idocs.show', 'Cancelar', array($idoc->id), array('class' => 'btn btn-danger btn-block edit-buttons', 'style' => 'margin-top: 30px;')) !!}
		</div>
		<div class="col-xs-6 col-sm-6 col-md-6">
