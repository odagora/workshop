@extends('main')
@section('title', '| Crear una nueva Orden de Reparación') 
@section('content')
<div class="row">
	<div class="col-xs-10 col-sm-10 col-md-8 col-xs-offset-1 col-sm-offset-1 col-md-offset-2">
		<h1 class="text-center">Crear una nueva Orden de Reparación</h1>
		<hr>
		{!! Form::open(array('name' => 'otdoc_form' , 'id' => 'otdoc_form' , 'route' => 'otdocs.store')) !!}
