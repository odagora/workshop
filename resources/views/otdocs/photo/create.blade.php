@extends('main')
@section('title', '| Subir Fotos Orden de Reparación')
@section('content')
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 index-header text-center">
		<h1>Subir Fotos Orden de Reparación</h1>
	</div>
	...
	<div class="col-xs-8 col-sm-8 col-md-6 col-xs-offset-2 col-sm-offset-2 col-md-offset-3">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				{!! Form::open(array('method'=>'POST', 'role'=>'form', 'route'=> ['otdocUploadImage', $doc_id], 'files'=> true)) !!}
