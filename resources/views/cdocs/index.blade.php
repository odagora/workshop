...
<div class="row">
	...
	<div class="col-xs-12 col-sm-3 col-md-2 index-button">
		<a href="{{ route('cdocs.create') }}" class="btn btn-lg btn-block btn-primary btn-h1-spacing">Crear cotización</a>
	</div>
	...
	<div class="col-md-12 table-responsive">
		<table class="table table-striped table-bordered">
			...
			<tbody>
				...
				<tr>
					<td class="text-center">{{$cdoc->id}}</td>
